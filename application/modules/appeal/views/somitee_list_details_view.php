                        ...
                        <div style="margin-bottom: 10px;">
                            <ol class="breadcrumb">
                                ...
                                <li>
                                    <?php
                                    if ($s_type == 'new') {
                                        echo '<a href="' . base_url('appeal/get_somitee/new') . '">নতুন সমবায় তালিকা</a>';
                                    } elseif ($s_type == 'all') {
                                        echo '<a href="' . base_url('appeal/get_somitee/all') . '">সকল সমবায় তালিকা</a>';
                                    } else if ($s_type == 'selected') {
                                        echo '<a href="' . base_url('appeal/get_somitee/selected') . '">সফল সমবায় তালিকা</a>';
                                    } else if ($s_type == 'reject') {
                                        echo '<a href="' . base_url('appeal/get_somitee/selected') . '">বাতিল সমবায় তালিকা</a>';
                                    } else if ($s_type == 'search') {
                                        echo '<a href="' . base_url('appeal') . '">অনুসন্ধান</a>';
                                    }
                                    ?>
                                </li>
                                ...
                                <div id="dwnloadDiv" style="width: 200px; background-color: #337ab7;"
                                    ...
                                    <b>
                                        <a id="linkTag" style="text-decoration:none; color: whitesmoke"
                                           href="<?php echo site_url('appeal/appeal_download_user_info/' . $somitee_info[0]['somitee_id']); ?>">আপনার
                            ...
                            <div class="panel panel-success" style="border-color: #6096c7">
                                ...
                                <div class="panel-body">
                                    ...
                                    <input type='hidden' name='appeal'
                                           value='<?php echo $appeal_info[0]['appeal_id']; ?>'>
                                    ...
                                    <div id="chk_btn_1" class="form-group">
                                        <div class="col-md-8 col-md-offset-2">
                                            <div class="col-md-6">
                                                <button type="submit" name='bttn' id="reject_1" value="reject"
...
<script>
    ...
    function get_admin_info(id, tbl, title) {
        ...
        $.ajax({
            type: 'post',
            url: '<?= site_url('appeal/get_all_admin_info');?>',
            data: {
                iid: id,
                tble: tbl
