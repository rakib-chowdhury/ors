                ...
                <?php if ($track == 1 && $pro == 0) { ?>
                    <div class="col-md-3 col-xs-12">
                        <div class="panel tracking well">
                            <table class="table table-stripped">
                                ...
                                <tr>
                                    <td>অফিস</td>
                                    <td><?php echo "অভিযোগ সমবায় অফিসার "; ?>
                                        <br>
                                        ঢাকা
                                    </td>
                                </tr>
                    ...
                    <div id="track_div" class="col-md-6 ">
                        <div class="panel tracking well" style="min-height: 100px !important">
                            ...
                            <form action="<?php echo site_url('complain/check_tracking_id'); ?>" method="post" style="margin-bottom: 0">
                        ...
                        <div class="panel tracking well" style="min-height: 200px; !important;">
                            ...
                            <table class="table table-bordered table-responsive">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; ">অভিযোগের তারিখ</td>
                                ...
                                <?php if (sizeof($new_somitee_info) == 0) {
                                    ...
                                    <tr>
                                        <td colspan="6" style="text-align: right;"><a
                                                href="<?php echo site_url('complain/get_somitee/new'); ?>">বিস্তারিত</a>
                                        </td>
                                    </tr>
                                <?php }
                                ?>
                    ...
                    <div class="col-md-3" style="padding-right: 30px;padding-top: 25px;">
                        <ul class="list-unstyled list-inline row">
                            ...
                            <li class="col-md-6 col-sm-6 col-lg-6 col-xs-6" style="margin-bottom: 25px; padding-left: 15px">
                                <a href="<?php echo site_url('complain/get_somitee/reply');?>"
                                   class="gnt-actn-btn btn-danger col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                    <i style="font-size: 50px; padding: 20px;"
                                       class="glyphicon glyphicon-file"></i>
                                    <span>রিপ্লাইকৃত আবেদন</span>
                                    <?php
                                    if($reply_somitee_info[0]['t']==0){
                                    }else{
                                        echo '<span class="badge1">'.str_replace(range(0,9),$bn_digits,$reply_somitee_info[0]['t']).'</span>';
                                    }
                                    ?>
                                </a>
                            </li>
                            <li class="col-md-6 col-sm-6 col-lg-6 col-xs-6" style="margin-bottom: 25px; padding-left: 15px">
                                <a data-toggle="modal" data-target="#myModal_pass" style="cursor:pointer" class="gnt-actn-btn btn-info col-md-12 col-sm-12 col-lg-12 col-xs-12">
                                    <i style="font-size: 50px; padding: 20px;"
                                       class="glyphicon glyphicon-file"></i>
