        ...
        <div class="col-md-10 display-table-cell" id="main-content">
            <div class="row">
                ...
                <div class="col-md-10 col-md-offset-1">
                    ...
                    <?php if ($somitee_info[0]['somitee_status'] == 0) { ?>
                    <?php
                    if (sizeof($check_uco) == 0 || sizeof($check_dco) == 0) {
                    if(sizeof($check_uco) == 0){ ?>
                    <div style="border: solid 1px red; text-align: center; padding-top: 10px;">
                        <p style="color: red">
                            দুঃখিত <?= $somitee_info[0]['bn_div_name'] . ', ' . $somitee_info[0]['bn_dist_name'] . ', ' . $somitee_info[0]['bn_upz_name'] . ' উপজেলার উপজেলা কর্মকর্তা নিযুক্ত করা হয় নাই'?></p>
                    </div>
                    <?php }?>
                    <?php if(sizeof($check_dco) == 0){ ?>
                    <div style="border: solid 1px red; text-align: center; padding-top: 10px;">
                        <p style="color: red">
                            দুঃখিত <?= $somitee_info[0]['bn_div_name'] . ', ' . $somitee_info[0]['bn_dist_name'] . ' জেলার জেলা কর্মকর্তা নিযুক্ত করা হয় নাই'?></p>
                    </div>
                    <?php }?>
                    <?php } else {
                    ?>
                    <form method='post' class="login-form" action='<?php echo site_url('doc/check_somitee'); ?>'>
                        <br>
                        <input type='hidden' name='somitee_id'
                               value='<?php echo $somitee_info[0]['somitee_id']; ?>'>

                        <div class="form-group" id="first-chck">
                            <div class="col-md-8 col-md-offset-2">
                                <div class="col-md-6">
                                    <button id="reject_button" type="button" name='bttn' value="reject"
                                            class="btn btn-danger gnt-btn btn-block">
                                        <span class="glyphicon glyphicon-floppy-saved"></span>&nbsp;
                                        &nbsp; বাতিল
                                    </button>
                                    <span>প্রাথমিক আবেদন  যথাযথ  না হওয়ায় বাতিল করা  হলো</span>
                                </div>
                                <div class="col-md-6">
                                    <button type="submit" name='bttn' value="accept"
                                            class="btn btn-success gnt-btn btn-block">
                                        <span class="glyphicon glyphicon-floppy-saved"></span>&nbsp;
                                        &nbsp;অনুমোদন
                                    </button>
                                    <span>পরবর্তী ব্যবস্থায় যাওয়ার জন্য গৃহীত হলো</span>
                                </div>
                            </div>
                        </div><!-- /first-check -->
                        <br>
                        <div id="reject-div">
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-2">
                                    <select name='doc_verify' id='doc_cmmnt'>
                                        <option value="">-- বাতিল কারন বাছাই করুন --</option>
                                        <option value="1">সমবায়ের নাম</option>
                                        <option value="2">সমবায়ের ঠিকানা</option>
                                        <option value="3">সমবায় গঠনের উদ্দেশ্য</option>
                                        <option value="4">সমবায়ের প্রাথমিক তথ্য</option>
                                        <option value="5">সমবায়ের শ্রেণি</option>
                                        <option value="6">সমবায়ের সদস্য</option>
                                    </select>
                                </div>
                            </div>
                            <div class="">
                                <div class="col-md-8 col-md-offset-2">
                                    <textarea class="summernote" name='cmmnt' id="cmmnt" hidden="hidden"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-2">
                                    <div class="col-md-6">
                                        <button id="reject_button_2" type="button" name='bttn' value="reject"
                                                class="btn btn-danger gnt-btn btn-block">বাতিল
                                        </button>
                                    </div>
                                    <div class="col-md-6">
                                        <button type="submit" name='bttn' value="reject"
                                                class="btn btn-success gnt-btn btn-block">নিশ্চিত করুন
                                        </button>
                                        <span>প্রাথমিক আবেদন  যথাযথ  না হওয়ায় বাতিল করা  হলো</span>
                                    </div>
                                </div>
...
<script>
 var finalEnlishToBanglaNumber = {
    ...
    $('#reject_button').click(function () {
        $('#reject-div').show();
        $('#doc_cmmnt').attr("required", "required");
        $('#cmmnt').attr("required", "required");
        $('#first-chck').hide();
    });
    $('#reject_button_2').click(function () {
        $('#reject-div').hide();
        $('#doc_cmmnt').removeAttr("required");
        $('#cmmnt').removeAttr("required");
        $('#first-chck').show();
    });
