                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane" id="wysiwyg-edit">
                            <form action="<?php echo site_url('division/get_div_work'); ?>" method="post">
                                ...
                                <div>
                                    <label>সমিতির স্টেটাস </label>&nbsp; &nbsp; &nbsp;
                                    <input type="radio" name="somitee_status" value="1">অনুমতি  প্রদান&nbsp;
                                    <input type="radio" name="somitee_status" value="2">সাজেশন&nbsp;
                                    <input type="radio" name="somitee_status" value="3">বাতিল&nbsp;
                                </div>
                                <br>
                                <div>
