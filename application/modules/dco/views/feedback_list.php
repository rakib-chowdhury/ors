                    ...
                    <div class="panel panel-success" style="border-color: #337ab7;">
                        ...
                        <div class="panel-body">
                            <div style="margin: 5px; margin-bottom: 15px;">
                                <a class="btn btn-info" data-toggle="modal" data-target="#addFeedback"
                                   style="cursor: pointer;">সংযোজন করুন</a>
                            </div>
                            <!-- Modal -->
                            <div id="addFeedback" class="modal fade" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <!-- Modal content-->
                                    <form action="<?= site_url('dco/feedback_post');?>" method="post">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close"
                                                        data-dismiss="modal">&times;</button>
                                                <h4 class="modal-title">জেলা কর্মকর্তার জিজ্ঞাসা</h4>
                                            </div>
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="row">
                                                        <div class="form-group col-md-10">
                                                            <label style="padding-top: 6px;" class="col-md-3">সমিতির নাম</label>
                                                            <div class="col-md-9">
                                                                <select required name="somiteeID" id="somiteeID" class="form-control">
                                                                    <?php
                                                                        foreach($newSomitee as $n){ ?>
                                                                        <option value="<?= $n['somitee_id']?>"><?= $n['somitee_name']?></option>
                                                                        <?php }
                                                                    ?>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <input type="hidden" name="dcoID" id="dcoID" value="<?=$admin_info[0]['admin_reg_id']?>">
                                                    <div class="row">
                                                        <div class="form-group col-md-10">
                                                            <label style="padding-top: 6px;" class="col-md-3">বিস্তারিত</label>
                                                            <div class="col-md-9">
                                                                <textarea required name="msg" id="msg" cols="30" class="form-control"
                                                                          rows="5"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            <table class="table table-striped table-bordered data-table" cellspacing="0">
                                ...
                                foreach ($feedbackSomitee as $key=>$feed){ ?>
                                    ...
                                    <td style="text-align: center;"><?= $feed['reply']?></td>
                                <?php }
                                ?>
                                </tbody>
                            </table>
